...
scientificname_author_team_samples = [('Hook. f.', ['Hook. f.']),
                                  ('(Wall.) Hook. f. et Thoms.', ['Wall.', 'Hook. f.', 'Thoms.']),
                                  ('H.Lév.', ['H.Lev.']),
                                  ('(Benth.)H.Rob.& Skvarla', ['Benth.', 'H.Rob.', 'Skvarla']),
                                  ('Sánchez-Gómez,A.F.Carrillo,A.Hern.,M.A.Carrión & Güemes',[ 'Sanchez-Gomez', 'A.F.Carrillo', 'A.Hern.', 'M.A.Carrion', 'Guemes']),
                                  ('(H.Stenzel) Karremans, Chiron & van den Berg', ['H.Stenzel', 'Karremans', 'Chiron', 'van den Berg']),
                                  ('Willd.(pro sp.)', ['Willd.']),
                                  ('(Hook. & Grev.) de la Sota', ['Hook.', 'Grev.', 'de la Sota']),
                                  ('(Ames & sine ref.) A.D.Hawkes', ['Ames sine ref.', 'A.D.Hawkes']),
                                  ('Sonder p.p.', ['Sonder']),
                                  ('(Hook. f. et Thoms.) Al-Shehbaz et al.', ['Hook. f.', 'Thoms.', 'Al-Shehbaz']),
                                  ('(Kurz ex Hook. f. et T. Anderson) O. E. Schulz', ['Hook. f.', 'T. Anderson', 'O. E. Schulz']),
                                  ('Kurz ex Hook. f. et T. Anderson', ['Hook. f.', 'T. Anderson']),
                                  ('A.St.-Hil. in A.St.-Hil., Juss. & Cambess.', ['A.St.-Hil.']),
                                  ('(Bruch in De Not.) Giac.', ['Bruch', 'Giac.']),
                                  ('(C.Aykurt & Sümbül) ined.', ['C.Aykurt', 'Sumbul']),
                                  ('Regel & Klein bis', ['Regel', 'Klein bis']),
                                  ('(Roxb.) Prain, nom.nud.', ['Roxb.', 'Prain']),
                                  ('(Desv.) de Wet & J.R.Harlan ex Davidse', ['Desv.', 'Davidse']),
